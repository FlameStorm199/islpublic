...
{
    /*
     * riassumendo, fare API per:
        - richiesta delle task non archiviate
        - richiesta di tutte le task (oppure soltanto di quelle archiviate)
        - archiviazione = modifica della task, da controller creare nuovo oggetto con status 5
        - inserimento
        - modifica
        - eliminazione
    */
